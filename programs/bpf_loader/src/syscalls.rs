...
declare_syscall!(
    ...
    fn call(
        ...
        use solana_zk_token_sdk::curve25519::{curve_syscall_traits::*, edwards, bls12381,ristretto};
        use solana_sdk::msg;
        let invoke_context = question_mark!(
            self.invoke_context
                .try_borrow()
        ...
        match curve_id {
            ...
            CURVEBLS12381 => {
                let cost = invoke_context
                    .get_compute_budget()
                    .curve25519_bls12381_validate_point_cost;
                question_mark!(invoke_context.get_compute_meter().consume(cost), result);
                ic_msg!(
                    invoke_context,
                    "Inner instructions");
                ...
                let point = question_mark!(
                    translate_type::<bls12381::PodBls12381G1Point>(
                        memory_mapping,
                        point_addr,
                        invoke_context.get_check_aligned()
                    ),
                ...
                if bls12381::validate_bls12381(&point) {
                    *result = Ok(1);
...
declare_syscall!(
    ...
    fn call(
        ...
        use solana_zk_token_sdk::curve25519::{
            curve_syscall_traits::*, edwards, ristretto,bls12381,scalar
        };
        ...
        match curve_id {
            ...
            CURVEBLS12381 => match group_op {
                ADD => {
                    ...
                    if let Some(result_point) = bls12381::add_bls12381(left_point, right_point) {
                        *question_mark!(
                            translate_type_mut::<bls12381::PodBls12381G1Point>(
                                memory_mapping,
                                result_point_addr,
                                invoke_context.get_check_aligned(),
                            ),
                ...
                SUB => {
                    let cost = invoke_context
                        .get_compute_budget()
                        .curve25519_bls12381_subtract_cost;
                    question_mark!(invoke_context.get_compute_meter().consume(cost), result);
                    ...
                    if let Some(result_point) =
                        bls12381::subtract_bls12381(left_point, right_point)
                    {
                        *question_mark!(
                            translate_type_mut::<bls12381::PodBls12381G1Point>(
                                memory_mapping,
                ...
                MUL => {
                    let cost = invoke_context
                        .get_compute_budget()
                        .curve25519_bls12381_multiply_cost;
                    question_mark!(invoke_context.get_compute_meter().consume(cost), result);

                    let scalar = question_mark!(
                        translate_type::<bls12381::PodScalar>(
                            memory_mapping,
                            left_input_addr,
                            invoke_context.get_check_aligned(),
                        ),
                    ...
                    if let Some(result_point) = bls12381::multiply_bls12381(scalar, input_point) {
                        *question_mark!(
                            translate_type_mut::<bls12381::PodBls12381G1Point>(
                                memory_mapping,
                                result_point_addr,
